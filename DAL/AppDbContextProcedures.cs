...
namespace DAL
{
    ...
    public partial class AppDbContextProcedures : IAppDbContextProcedures
    {
        ...
        public virtual async Task<int> usp_addemployeeAsync(string Name, string Address, int? DepartmentId, OutputParameter<bool?> Status, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default)
        {
        ...
        public virtual async Task<int> usp_deleteemployeeAsync(int? Id, OutputParameter<bool?> Status , OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default)
        {
            var parameterStatus = new SqlParameter
            {
                ParameterName = "Status",
        ...
        public virtual async Task<int> usp_updateemployeeAsync(int? Id, string Name, string Address, int? DepartmentId, OutputParameter<bool?> Status = default, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default)
        {
            var parameterStatus = new SqlParameter
            {
                ParameterName = "Status",
